...
public class Controlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (menu.equals("PrincipalP")) {
            request.getRequestDispatcher("PrincipalP.jsp").forward(request, response);
        }
        if (menu.equals("PrincipalE")) {
        ...
        if (menu.equals("Estudiante")) {
            switch (accion) {
                case "Listar":
                    List lista = esdao.listarEstudiante();
        ...
        if (menu.equals("Materia")) {
            switch (accion) {
                case "Listar":
                    List lista = madao.listarMateria();
